@extends('layouts.plantilla') @section('contenido') @section('title','Editar producto')
    ...
    <main class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                ...
                <div class="form-floating">
                    <input type="submit" class="form-control" id="floatingPassword" placeholder="Password">
